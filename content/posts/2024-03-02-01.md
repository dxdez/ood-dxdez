---
title: "Developing Native Cloud Apps in GO"
date: 2024-03-02T22:08:39-05:00
draft: false
---

[Learning Cloud Native Go](https://learning-cloud-native-go.github.io/ "Learning Cloud Native Go") - Cloud Native Application Development is a one way of speeding up building web applications, using micro-services, containers and orchestration tools. This website provides tutorials on construting applications in the GO language. 

[Dockerized RESTful App in GO](https://github.com/learning-cloud-native-go/myapp "Dockerized RESTful App in GO) - This repository shows how to build a Dockerized RESTful API application in Go for a simple bookshelf. The overview of the README is shown below:
